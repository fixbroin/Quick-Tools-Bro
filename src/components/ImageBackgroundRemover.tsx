      ...
      <section className="prose prose-slate dark:prose-invert max-w-none space-y-8">
        <div className="bg-primary/5 rounded-2xl p-8 border border-primary/10">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Our Image Background Remover uses state-of-the-art **WebAssembly (WASM)** and **Artificial Intelligence** to segment the subject of your photo from its background directly in your browser. Unlike other tools that upload your private photos to their servers, our tool processes everything locally on your device.
          </p>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-lg border bg-card">
              <h4 className="font-semibold mb-2">Can I remove background from any image?</h4>
              <p className="text-sm text-muted-foreground">Yes! Our tool supports JPG, PNG, and WebP formats. It works best on images with a clear subject (like people, pets, or products).</p>
            </div>
            <div className="p-4 rounded-lg border bg-card">
              <h4 className="font-semibold mb-2">What is the output format?</h4>
              <p className="text-sm text-muted-foreground">All results are saved as **PNG** files because this format supports the transparency needed for a background-free result.</p>
            </div>
          </div>
        </div>
      </section>
