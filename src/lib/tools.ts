...
import { QrCode, ScanLine, Minimize, Replace, Expand, Smile, Image as ImageIcon, FileText, FileImage, Scale, Landmark, HeartPulse, PersonStanding, Banknote, Heart, Gem, Link as LinkIcon, Soup, Shield, FileType, LucideIcon, Video, RefreshCw, Undo, Youtube, Receipt } from 'lucide-react';
...
export const tools: Tool[] = [
  ...
  // Creative Tools
  {
    title: 'AI YouTube Thumbnail Maker',
    name: 'AI YouTube Thumbnail Maker',
    description: 'Design eye-catching YouTube thumbnails.',
