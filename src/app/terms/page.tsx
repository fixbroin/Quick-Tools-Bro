        ...
        <div className="container mx-auto max-w-4xl px-4 py-8">
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <p>
                        By accessing and using {SITE_CONFIG.name} (the "Service"), you agree to be bound by these Terms of Use and our Privacy Policy. If you do not agree to these terms, please do not use our services.
                    </p>
                    ...
                    <p>
                        In no event shall {SITE_CONFIG.name}, its owners, or affiliates be liable for any indirect, incidental, special, consequential or punitive damages arising out of or in connection with your use of the services. This includes, but is not limited to, any loss of data, revenue, or profits.
                    </p>
