...
const toolCategories = [
  ...
  {
    name: 'Image Tools',
    tools: tools.filter(t => ['Image Compressor', 'Image Converter', 'Image Resizer', 'Image Background Remover', 'Image Cropper', 'Favicon Converter', 'Feature Graphic Generator'].includes(t.name)),
