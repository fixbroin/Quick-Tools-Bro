        ...
        if (savedProfile) {
            try {
                ...
                setFormState(prev => ({
                    ...
                    yourCompanyGstin: profile.gstin || '',
  ...
  const generatePdf = async () => {
    ...
    try {
        ...
        const headers = [
          ...
          { content: 'HSN', styles: { halign: 'left' as const } },
          ...
          { content: `CGST (${currencySymbol})`, styles: { halign: 'right' as const } },
          { content: `SGST (${currencySymbol})`, styles: { halign: 'right' as const } },
