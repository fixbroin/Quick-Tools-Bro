...
export default function BioGeneratorPage() {
  return (<>
      ...
      description="Create descriptive, structured profile bios tailored for LinkedIn, Twitter, or Instagram."
    />
      
      <section className="mt-12 space-y-8 prose prose-slate dark:prose-invert max-w-none">
        <div className="bg-primary/5 rounded-2xl p-6 md:p-10 border border-primary/10">
            <h2 className="text-3xl font-bold font-headline mb-6">Why Use Our Social Bio Generator?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm leading-relaxed">
                <div className="space-y-4">
                    <p>
                        <strong className="text-primary font-bold">Free & Secure:</strong> Our Social Bio Generator is 100% free and runs completely in your web browser. No registration, signup, or installation is required.
                    </p>
                    <p>
                        Generate bio lines for social profiles.
                    </p>
                </div>
                <div className="space-y-4">
                    <p>
                    ...
                    <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
                        <li>Open the Social Bio Generator tool on UseBro.</li>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-xl border border-border/50 bg-card hover:border-primary/50 transition-colors">
                    <h4 className="font-bold mb-2 text-base">Is the Social Bio Generator tool free to use?</h4>
                ...
                <div className="p-6 rounded-xl border border-border/50 bg-card hover:border-primary/50 transition-colors">
                    <h4 className="font-bold mb-2 text-base">Does this Social Bio Generator upload my files to a server?</h4>
                ...
                <div className="p-6 rounded-xl border border-border/50 bg-card hover:border-primary/50 transition-colors">
                    <h4 className="font-bold mb-2 text-base">Can I use Social Bio Generator on my mobile device?</h4>
