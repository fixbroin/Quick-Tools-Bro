        ...
        <div className="container mx-auto max-w-4xl px-4 py-8">
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <p>
                        Welcome to {SITE_CONFIG.name}. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our services. By using our website, you consent to the data practices described in this policy.
                    </p>
